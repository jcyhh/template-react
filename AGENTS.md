...
For example, use `className="flex jc ac tc size-24"` instead of rewriting the same flex, alignment, text-align or font-size CSS.
例如，使用 `className="flex jc ac tc size-24"`，不要重复编写同等的 flex、对齐、文本居中或字号 CSS。
